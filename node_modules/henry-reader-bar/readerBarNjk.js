module.exports = (njk, height = '4px', bgColor = '#010101', fillColor = 'orange') => {
  ...
  <!-- reader bar -->
  <div id="readerBarContainer" style="height:${height};width:100%;background-color:${bgColor};position:fixed;top:66px;left:0;z-index:1099;transition:0.2s;">
    <div id="readerBar" style="height:${height};width:0;background-color:${fillColor};position:fixed;top:66px;left:0;z-index:1099;transition:0.2s;"></div>
  </div>
