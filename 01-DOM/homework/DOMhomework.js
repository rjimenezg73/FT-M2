...
// Tu código acá:
var autor = document.querySelector("#createdBy");
autor.innerHTML += "Pepe";
// #n === selecciona un TAG por su ID
// .n === selecciona TAGS por su clasen
...
//
// var tarea = new ToDo("algo") // === {description: "algo", complete: false}
...
function addToDo() {
  ...
  var tarea = new ToDo(toDoInput.value); // {description: "comprar papel"}
  if (toDoInput.value) {
