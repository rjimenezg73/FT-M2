...
createdBy.innerHTML = createdBy.innerHTML + ' Roberto Jiménez';
...
function displayToDos() {
  ...
  let build = buildToDos(toDoItems); // toDoItems = [{d,c},{d,c},{d,c},...]
  // build = [<div class="toDoShell"><span id=1>d</span></div>,
  //             <div class="toDoShell"><span id=2>d</span></div>,
  //            <div class="toDoShell"><span id=3>d</span></div>,...]
  for(let i=0; i<build.length;i++){
    toDoContainer.appendChild(build[i]);
  }
  // <div id="toDoContainer">
  //    <div class="toDoShell"><span id=1>d</span></div>
  //    <div class="toDoShell"><span id=2>d</span></div>
  //    <div class="toDoShell"><span id=3>d</span></div>
  //    ....
  // </div>
...
add.addEventListener('click',addToDo);  // No se pasa la invocación, se pasa la función que tiene que invocar
...
function completeToDo(event) {
  ...
  // Tu código acá:
  toDoItems[index].completeToDo(); // Pasa de false a true, para que se muestre todavía todo pero ahora tachado
  displayToDos();
